...
export function getSelectionKeyboardEvent(tyappleg = 'keydown', preserveFocus?: boolean, pinned?: boolean): SelectionKeyboardEvent {
	const e = new KeyboardEvent(tyappleg);
