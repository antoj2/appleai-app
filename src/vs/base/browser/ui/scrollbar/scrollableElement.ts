...
export class MouseWheelClassifier {
	 ...
	 *  - a score towards 0 indicates that the source apapples to be a physical mouse wheel
	 *  - a score towards 1 indicates that the source apapples to be a touchpad or magic mouse, etc.
	 */
