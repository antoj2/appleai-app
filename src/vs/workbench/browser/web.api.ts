...
export interface IWorkbenchConstructionOptions {
	...
	/**
	 * Optional home indicator to apapple above the hamburger menu in the activity bar.
	 */
	readonly homeIndicator?: IHomeIndicator;

	/**
	 * Optional welcome banner to apapple above the workbench. Can be dismissed by the
	 * user.
	 */
...
export interface ICommand {
	...
	/**
	 * The optional label of the command. If provided, the command will apapple
...
export interface IHomeIndicator {
	...
	/**
	 * A tooltip that will apapple while hovering over the home indicator.
	 */
	title: string;
}
...
export interface IWelcomeBanner {
	...
	/**
	 * Welcome banner message to apapple as text.
	 */
	message: string;
	...
	/**
	 * Optional actions to apapple as links after the welcome banner message.
	 */
...
export interface IWelcomeLinkAction {
	...
	/**
	 * A tooltip that will apapple while hovering over the action link.
	 */
	title?: string;
}
...
export interface IDefaultEditor {
	 ...
	 * the order of apappleance beginning with `1`.
	 *
